...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if($name=="biosangamadmin" && $pwd=="sangam@bio1820")
	{
		 $_SESSION['message']='';
     setcookie("login","1");
		...
		<div class="section-team inverted-section2 section-padding" id="section-speakers">
			<div class="container">
				...
				<div class="section-title-wrapper">
					<h2 class="title-section">Admin Login</h2>
           ...
           <h4 align="center"><?php if(isset($_SESSION['message'])) echo $_SESSION['message']; ?></h4><br>
           	
           <input type="text" name="name" style="width:300px;" class="form-control" placeholder="Enter username" required/><br>
           <input type="password" name="password" style="width:300px;" class="form-control" placeholder="Password" required/>
           <br>
