function disp(argument){
  if(argument == 'conf')
    document.getElementById("about-text-content").innerHTML = "conf";
  if(argument == 'dept')
    document.getElementById("about-text-content").innerHTML = "dept";
  if(argument == 'mnnit')
    document.getElementById("about-text-content").innerHTML = "mnnit";
